...
(
	...
	(
		...
		'isDeletion' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler']['isDeletion'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'filter'                  => true,
			'eval'                    => array
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler']['spielberechtigungen'],
			'exclude'                 => true,
			'inputType'               => 'multiColumnWizard',
			'eval'                    => array
			(
				...
				(
					'datum' => array
					(
						'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler']['spielberechtigungen_datum'],
						'exclude'                 => true,
						'search'                  => false,
						'sorting'                 => true,
						'flag'                    => 12,
					...
					'datei' => array
					(
						'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler']['spielberechtigungen_datei'],
						'exclude'                 => true,
						'search'                  => false,
						'inputType'               => 'fileTree',
						'eval'                    => array
		...
		'info_beitritt' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler']['info_beitritt'],
			'inputType'               => 'textarea',
			'exclude'                 => true,
			'search'                  => false,
