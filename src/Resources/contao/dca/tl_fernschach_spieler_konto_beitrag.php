...
(
	...
	(
		...
		(
			...
			'child_record_callback'   => array('tl_fernschach_spieler_konto_beitrag', 'listBuchungen'),
...
class tl_fernschach_spieler_konto_beitrag extends \Backend
{
	...
	public function listBuchungen($arrRow)
	{
		...
		$temp .= '<span style="display:inline-block; width:100px; '.$css.'">'.@$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['art_options'][$arrRow['art']].'</span>';
