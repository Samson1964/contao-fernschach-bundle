...
/**
 * Table tl_fernschach_spieler_konto_beitrag
 */
$GLOBALS['TL_DCA']['tl_fernschach_spieler_konto_beitrag'] = array
(
	...
	(
		...
		(
			...
			'showColumns'             => true,
			'label_callback'          => array('tl_fernschach_spieler_konto_beitrag', 'getLabel')
		),
		'global_operations' => array
		(
			'verschiebeBuchungen' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['verschiebeBuchungen'],
				'href'                => 'key=verschiebeBuchungen',
				'icon'                => 'bundles/contaofernschach/images/move.png'
			),
			'importBuchungen' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['importBuchungen'],
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.svg',
				'button_callback'     => array('tl_fernschach_spieler_konto_beitrag', 'generateEditButton')
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['copy'],
				'href'                => 'act=paste&amp;mode=copy',
				'icon'                => 'copy.svg',
				'button_callback'     => array('tl_fernschach_spieler_konto_beitrag', 'generateCopyButton')
			),
			'delete' => array
			(
			...
			'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['toggle'],
				...
				//'button_callback'     => array('tl_fernschach_spieler_konto_beitrag', 'generateToggleButton')
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['show'],
				'href'                => 'act=show',
	...
	(
		...
		'betrag' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['betrag'],
			'exclude'                 => true,
			'sorting'                 => true,
			'inputType'               => 'text',
			'eval'                    => array
			...
			'load_callback'           => array
			(
				array('tl_fernschach_spieler_konto_beitrag', 'getBetrag')
			),
			'save_callback' => array
			(
				array('tl_fernschach_spieler_konto_beitrag', 'putBetrag')
			),
			'sql'                     => "varchar(6) NOT NULL default ''"
		),
		'typ' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['typ'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['typ_options'],
			'eval'                    => array
			(
				'tl_class'            => 'w50',
				'multiple'            => false,
		...
		'datum' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['datum'],
			'default'                 => time(),
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 6,
			...
			'load_callback' => array
			(
				array('tl_fernschach_spieler_konto_beitrag', 'loadDate')
			),
			'sql'                     => "int(10) unsigned NOT NULL default 0"
		),
		'sortierung' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['sortierung'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'eval'                    => array
			(
		...
		'kategorie' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['kategorie'],
			'exclude'                 => true,
			'sorting'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['kategorie_options'],
			'eval'                    => array
			(
				'tl_class'            => 'w50 clr',
				'multiple'            => false,
		...
		'art' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['art'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['art_options'],
			'eval'                    => array
			(
				'tl_class'            => 'w50',
				'multiple'            => false,
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['verwendungszweck'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'inputType'               => 'text',
		...
		'markierung' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['markierung'],
			'inputType'               => 'checkbox',
			'exclude'                 => true,
			'default'                 => '',
			'filter'                  => true,
		...
		'saldoReset' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['saldoReset'],
			'inputType'               => 'checkbox',
			'exclude'                 => true,
			'default'                 => '',
			'filter'                  => true,
		...
		(
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_fernschach_spieler_konto_beitrag', 'getTurniere'),
			'eval'                    => array
			(
				'tl_class'            => 'w50',
				'includeBlankOption'  => true,
		...
		'meldungId' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['meldungId'],
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['published'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'default'                 => 1,
			'filter'                  => true,
		...
		'saldo' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto_beitrag']['saldo'],
		),
	)
);

/**
 * Class tl_fernschach_spieler_konto_beitrag
 *
 ...
 * @package    News
 */
class tl_fernschach_spieler_konto_beitrag extends \Backend
{
	...
	public function checkPermission(\DataContainer $dc)
	{
		...
		if(!$this->User->hasAccess('import', 'fernschach_konto')) unset($GLOBALS['TL_DCA']['tl_fernschach_spieler_konto_beitrag']['list']['global_operations']['importBuchungen']);
		if(!$this->User->hasAccess('all', 'fernschach_konto')) unset($GLOBALS['TL_DCA']['tl_fernschach_spieler_konto_beitrag']['list']['global_operations']['all']);
		if(!$this->User->hasAccess('create', 'fernschach_konto')) $GLOBALS['TL_DCA']['tl_fernschach_spieler_konto_beitrag']['config']['closed'] = true;
