...
/**
 * Table tl_fernschach_konten_buchungen
 */
$GLOBALS['TL_DCA']['tl_fernschach_konten_buchungen'] = array
(
	...
	(
		...
		'ptable'                      => 'tl_fernschach_konten',
		'enableVersioning'            => true,
		'onload_callback'             => array
		(
			//array('tl_fernschach_konten_buchungen', 'checkPermission'),
			//array('tl_fernschach_konten_buchungen', 'checkSaldo')
		),
		'sql' => array
		(
			'keys' => array
	...
	(
		...
		(
			...
			'flag'                    => 3,
			'headerFields'            => array('title', 'type', 'description'),
			'panelLayout'             => 'filter;sort;search,limit',
			'child_record_callback'   => array('tl_fernschach_konten_buchungen', 'listBuchungen'),
		...
		(
			...
			//(
			//	'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['importBuchungen'],
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.svg',
				'button_callback'     => array('tl_fernschach_konten_buchungen', 'generateEditButton')
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.svg',
				'button_callback'     => array('tl_fernschach_konten_buchungen', 'generateCopyButton')
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.svg',
				'attributes'          => 'onclick="if(!confirm(\'' . ($GLOBALS['TL_LANG']['MSC']['deleteConfirm'] ?? null) . '\'))return false;Backend.getScrollOffset()"',
				'button_callback'     => array('tl_fernschach_konten_buchungen', 'generateDeleteButton')
			),
			'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['toggle'],
				'attributes'          => 'onclick="Backend.getScrollOffset()"',
				'href'                => 'act=toggle&amp;field=published',
				'icon'                => 'visible.svg',
				//'button_callback'     => array('tl_fernschach_konten_buchungen', 'generateToggleButton')
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['show'],
				'href'                => 'act=show',
				...
				//'button_callback'     => array('tl_fernschach_konten_buchungen', 'generateShowButton')
			),
			//'markiertIcon' => array
			//(
			//	'label'               => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['markiertIcon'],
	...
	'palettes' => array
	(
		'default'                     => '{buchung_legend},soll,haben,typ,datum,sortierung,kategorie,art,verwendungszweck;{extras_legend},markierung,saldoReset;{turnier_legend:hide},turnier;{comment_legend:hide},comment;{connection_legend},meldungId;{publish_legend},published'
	),
	...
	(
		...
		'soll' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['soll'],
			'exclude'                 => true,
			'sorting'                 => true,
			'inputType'               => 'text',
			'eval'                    => array
			...
			'load_callback'           => array
			(
				array('tl_fernschach_konten_buchungen', 'getBetrag')
			),
			'save_callback' => array
			(
				array('tl_fernschach_konten_buchungen', 'putBetrag')
			),
			'sql'                     => "varchar(9) NOT NULL default ''"
		),
		'haben' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['haben'],
			'exclude'                 => true,
			'sorting'                 => true,
			'inputType'               => 'text',
			'eval'                    => array
		...
		'typ' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['typ'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['typ_options'],
			'eval'                    => array
			(
				'tl_class'            => 'w50',
				'multiple'            => false,
		...
		'datum' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['datum'],
			'default'                 => time(),
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 6,
			...
			'load_callback' => array
			(
				array('tl_fernschach_konten_buchungen', 'loadDate')
			),
			'sql'                     => "int(10) unsigned NOT NULL default 0"
		),
		'sortierung' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['sortierung'],
			'exclude'                 => true,
			'flag'                    => 6,
			'inputType'               => 'text',
			'eval'                    => array
		...
		'kategorie' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['kategorie'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['kategorie_options'],
			'eval'                    => array
			(
				'tl_class'            => 'w50 clr',
				'multiple'            => false,
		...
		'art' => array(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['art'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['art_options'],
			'eval'                    => array
			(
				'tl_class'            => 'w50',
				'multiple'            => false,
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['verwendungszweck'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'inputType'               => 'text',
		...
		'markierung' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['markierung'],
			'inputType'               => 'checkbox',
			'exclude'                 => true,
			'default'                 => '',
			'filter'                  => true,
		...
		'saldoReset' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['saldoReset'],
			'inputType'               => 'checkbox',
			'exclude'                 => true,
			'default'                 => '',
			'filter'                  => true,
		...
		(
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_fernschach_konten_buchungen', 'getTurniere'),
			'eval'                    => array
			(
				'tl_class'            => 'w50',
				'includeBlankOption'  => true,
		...
		'meldungId' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['meldungId'],
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['published'],
...
/**
 * Class tl_fernschach_konten_buchungen
 *
 ...
 * @package    News
 */
class tl_fernschach_konten_buchungen extends Backend
{
	...
	public function checkPermission()
	{
		...
		if(!$this->User->hasAccess('import', 'fernschach_konto')) unset($GLOBALS['TL_DCA']['tl_fernschach_konten_buchungen']['list']['global_operations']['importBuchungen']);
		if(!$this->User->hasAccess('all', 'fernschach_konto')) unset($GLOBALS['TL_DCA']['tl_fernschach_konten_buchungen']['list']['global_operations']['all']);
		if(!$this->User->hasAccess('create', 'fernschach_konto')) $GLOBALS['TL_DCA']['tl_fernschach_konten_buchungen']['config']['closed'] = true;
	...
	public function listBuchungen($arrRow)
	{
		...
		// Resetbuchung = true (schwarze Linie unten). Ohne Vorbelegung stünde
		// bei einer gewöhnlichen Buchung eine undefinierte Variable im Stil-Attribut.
		$resetCss = '';
		...
		$temp .= '<span style="display:inline-block; width:100px; '.$css.'">'.$GLOBALS['TL_LANG']['tl_fernschach_konten_buchungen']['art_options'][$arrRow['art']].'</span>';
	...
	{
		return($this->User->isAdmin || $this->User->hasAccess('edit', 'fernschach_konto')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>'.Image::getHtml($icon, $label).'</a> ' : Image::getHtml(preg_replace('/\.svg$/i', '_.svg', $icon)).' ';
	}
	...
	{
		return($this->User->isAdmin || $this->User->hasAccess('copy', 'fernschach_konto')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>'.Image::getHtml($icon, $label).'</a> ' : Image::getHtml(preg_replace('/\.svg$/i', '_.svg', $icon)).' ';
	}
	...
	{
		return($this->User->isAdmin || $this->User->hasAccess('delete', 'fernschach_konto')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>'.Image::getHtml($icon, $label).'</a> ' : Image::getHtml(preg_replace('/\.svg$/i', '_.svg', $icon)).' ';
	}
	...
	{
		return($this->User->isAdmin || $this->User->hasAccess('toggle', 'fernschach_konto')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>'.Image::getHtml($icon, $label).'</a> ' : Image::getHtml(preg_replace('/\.svg$/i', '_.svg', $icon)).' ';
	}
	...
	{
		return($this->User->isAdmin || $this->User->hasAccess('show', 'fernschach_konto')) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>'.Image::getHtml($icon, $label).'</a> ' : Image::getHtml(preg_replace('/\.svg$/i', '_.svg', $icon)).' ';
	}
