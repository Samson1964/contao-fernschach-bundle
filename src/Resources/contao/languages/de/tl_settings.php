...
$GLOBALS['TL_LANG']['tl_settings']['fernschach_resetUpdate'] = array('Updatedatum Kontostand','Datum und Uhrzeit der letzten Berechnung des Kontostandes in der Spielerliste. Die erneute Aktualisierung erfolgt, wenn der Zeitpunkt länger als 24 Stunden zurückliegt. Durch Ändern des Zeitpunktes können Sie die Aktualisierung beeinflussen.');
$GLOBALS['TL_LANG']['tl_settings']['fernschach_membershipUpdate'] = array('Updatedatum Mitgliedsstatus','Datum und Uhrzeit der letzten Prüfung des Mitgliedsstatus in der Spielerliste. Die erneute Aktualisierung erfolgt, wenn der Zeitpunkt länger als 24 Stunden zurückliegt. Durch Ändern des Zeitpunktes können Sie die Aktualisierung beeinflussen.');
$GLOBALS['TL_LANG']['tl_settings']['fernschach_maintenanceUpdate'] = array('Updatedatum Wartung','Datum und Uhrzeit der letzten Wartung der Spielerliste. Die erneute Aktualisierung erfolgt, wenn der Zeitpunkt länger als 12 Stunden zurückliegt. Durch Ändern des Zeitpunktes können Sie die Aktualisierung beeinflussen.');
