...
class Streichung
{
	...
	public function onDaily(): void
	{
		...
		\System::getContainer()->get('monolog.logger.contao.cron')->info('[Fernschach-Wartung] Prüfung Mitgliedschaftsstreichung gestartet');
		...
		// Log-Eintrag vornehmen
		\System::getContainer()->get('monolog.logger.contao.cron')->info('[Fernschach-Wartung] Prüfung Mitgliedschaftsstreichung beendet');
