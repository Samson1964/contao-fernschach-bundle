			...
			if($do == 'fernschach-spieler' && $table == 'tl_fernschach_spieler_konto')
			{
				...
				(
					...
					<tr>
					  ...
					  <td><a style="color:blue;" href="'.Controller::addToUrl('key=move&rt='.Scope::getRequestToken()).'" onclick="if(!confirm(\'Verschiebung der Buchungen starten?\'))return false;Backend.getScrollOffset()">Buchungen verschieben</a>:<br>'.$GLOBALS['TL_LANG']['tl_fernschach_spieler_konto']['verschieben'].'</td>
					</tr>
					</table><br></div>',
					'<div class="tl_listing_container list_view" id="tl_listing"><div class="tl_header click2edit toggle_select hover-div"><table class="tl_header_table">
					<tr>
